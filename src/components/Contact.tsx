          ...
          <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:2200030970cseh@gmail.com" className="text-blue-600 hover:text-blue-800 transition">2200030970cseh@gmail.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:9030451676" className="text-blue-600 hover:text-blue-800 transition">(+91) 9030451676</a>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <p className="text-gray-700 mb-6">
                You can also reach me on these platforms. I usually respond within 24 hours.
              </p>
              
              <div className="flex space-x-6">
                <a 
                  href="https://github.com/karthikapadal23" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.linkedin.com/in/karthika-padala/" 
                  target="_blank" 
                  rel="noopener noreferrer"
